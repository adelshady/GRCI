...
public class ResubmitChecklistTemplateHandler : IRequestHandler<ResubmitChecklistTemplateCommand>
{
    private readonly IChecklistTemplateRepository _repository;
    private readonly IWorkflowManager _workflowManager;
    private readonly ICurrentUser _currentUser;

    public ResubmitChecklistTemplateHandler(
    ...
    public async Task Handle(ResubmitChecklistTemplateCommand request, CancellationToken cancellationToken)
    {
